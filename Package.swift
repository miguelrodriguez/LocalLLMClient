...
// 👇 ESTO NO ESTABA EN TU MANIFEST
// Helper para leer variables de entorno dentro del manifest
enum Context {
    static let environment: [String: String] = ProcessInfo.processInfo.environment
}

// Para poder hacer: Context.environment["LDFLAGS", default: ""]
extension Dictionary where Key == String, Value == String {
    subscript(_ key: String, default defaultValue: String) -> String {
...
packageTargets.append(contentsOf: [
    ...
    // 👇 este es el xcframework oficial de llama.cpp
    .binaryTarget(
    ...
    // 👇 AQUÍ está el problema que te daba ‘memory’ not found
    .target(
        ...
        cSettings: [
            // forzamos a que lo trate como C++
            .unsafeFlags(["-std=c++17", "-x", "c++"]),
            .headerSearchPath("."),
        ],
        cxxSettings: [
            .headerSearchPath("."),
